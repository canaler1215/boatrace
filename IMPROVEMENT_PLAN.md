...
**最終更新**: 2026-04-17
**現在のセッション**: **Session 6 検証完了（S6-3 長期 Walk-Forward 実行待ち）**
...
- [ ] S6-3: Walk-Forward 期間延長（2024-01〜2025-12） **← 次のアクション**
  - 24ヶ月以上の検証で月次ROI分散を把握し、統計的信頼性を確認
...
**→ S6-3（長期 Walk-Forward 2024-01〜2025-12）を即実行する**。GH Actions `run_long_walkforward=true` で 24 ヶ月分を検証し、月次 ROI の統計的分布を把握する。
