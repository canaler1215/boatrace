...
最終更新: 2026-04-25（フェーズ6 タスク 6-10-c 着手・Purged CV PoC 完了、採用基準達成 0、次は C1/C2 キャリブレーション再設計）
...
- [ ] **6-10. 構造変更フェーズ（パラメータ探索打ち止め → 構造変更）** 🔴 進行中
  ...
  - **6-10-c. キャリブレーション再設計 / Purged CV** 🟡 進行中（2026-04-25 着手）
    ...
    - 候補 1: キャリブレーション再設計（per-class IR → 結合 IR / Dirichlet） 📋 未着手（次に着手）
